...
% Create arrow1
annotation(gcf, 'arrow', [0.288842544316997 0.279979144942649], [0.434 0.45875],...
    'Color', [1 0 0], 'LineWidth', 2, 'HeadStyle', 'plain');

% Create arrow2
annotation(gcf, 'arrow', [0.437434827945777 0.428571428571429], [0.43275 0.4575], ...
    'Color', [1 0 0], 'LineWidth', 2, 'HeadStyle', 'plain');

% Create arrow3
annotation(gcf, 'arrow', [0.584462982273202 0.575599582898853], [0.434 0.45875],...
    'Color', [1 0 0], 'LineWidth', 2, 'HeadStyle', 'plain');

% Create arrow1
annotation(gcf, 'arrow', [0.86339937434828 0.870698644421274], [0.68375 0.70625], ...
    'Color', [0 0.4470 0.7411], 'LineWidth', 2, 'HeadStyle', 'plain');

% Create arrow2
annotation(gcf, 'arrow', [0.862356621480709 0.869655891553704], [0.4075 0.43],...
    'Color', [0 0.4470 0.7411], 'LineWidth', 2, 'HeadStyle', 'plain');

% Create arrow3
annotation(gcf, 'arrow', [0.86339937434828 0.870698644421274], [0.13625 0.15875], ...
    'Color', [0 0.4470 0.7411], 'LineWidth', 2, 'HeadStyle', 'plain');

export_fig('figure5', '-r600', '-tif', '-c[360,1440,540,1800]'); % [top,right,bottom,left]
